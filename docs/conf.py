...
def run_apidoc(app):
    ...
    better_apidoc.main(
        [
            ...
            '-o',
            str(DOCS / 'API'),
            os.path.join(DOCS / '..' / 'src' / 'pypkg_m7rap'),
        ]
    )
...
version = pypkg_m7rap.__version__
release = version
git_tag = "v%s" % version
...
extlinks = {
    'issue': ('https://github.com/goerz/pypkg_m7rap/issues/%s', '#'),
    'pr': ('https://github.com/goerz/pypkg_m7rap/pull/%s', 'PR #'),
}
